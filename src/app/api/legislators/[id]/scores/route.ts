...
export async function GET(
  ...
  try {
    const response = await fetch(`${BACKEND_BASE}/legislators/${id}/scores`, {
    ...
    console.warn(`[Legislators Scores API Proxy]: Backend unavailable, serving scores for ${id} from Mock Database`);
